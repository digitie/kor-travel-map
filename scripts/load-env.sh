...
export KOR_TRAVEL_MAP_API_PORT="${KOR_TRAVEL_MAP_API_PORT:-12301}"
...
export KOR_TRAVEL_MAP_POSTGRES_HOST_PORT="${KOR_TRAVEL_MAP_POSTGRES_HOST_PORT:-15432}"
...
export KOR_TRAVEL_MAP_KOR_TRAVEL_GEO_BASE_URL="${KOR_TRAVEL_MAP_KOR_TRAVEL_GEO_BASE_URL:-http://127.0.0.1:12201}"
