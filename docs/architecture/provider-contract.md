...
| python-knps-api | `@16e3954` | `KnpsPointRecord`/`KnpsGeometryRecord` | PR#25 | keyless file-only, ADR-028 amendment 2026-05-25. `16e3954`: trails vertex 행 → 코스 단위 LINESTRING 조립(provider PR#10) |
