...
- **의사결정 대기(차단요소 포함)**: `docs/adr045-open-decisions.md` — D-1~D-16.
  먼저 해소: D-2(Dagster DB) / D-6(큐 모델) / D-7(features admin↔user) / D-11
  (sigungu 경계) / D-14(offline 저장).
...
**1차 진입 task**(권장): D 결정 일부 해소 → T-205a(`feature_update_requests`
