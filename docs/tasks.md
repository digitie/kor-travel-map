...
**진행 중**: ADR-045 독립 프로그램화 후속. main은 PR#201(T-RV-28 frontend Docker
npm lockfile + `npm ci`)까지 merged. 코드 리뷰 후속 흐름으로, 이번 PR은
`T-RV-26`(Docker healthcheck/readiness)을 닫는다.
...
- **T-RV-19~T-RV-25, T-RV-27, T-RV-29~T-RV-36** — poi-cache list
