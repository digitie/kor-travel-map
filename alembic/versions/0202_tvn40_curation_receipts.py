...
Revision ID: 0202_tvn40_curation_receipts
...
revision: str = "0202_tvn40_curation_receipts"
...
def downgrade() -> None:
    raise RuntimeError("0202_tvn40_curation_receipts is forward-only; rebuild with the T-VN-40 release head")
