...
from krtour.map.infra.ops_repo import OpsIntegrityIssue, OpsIntegrityIssuePage

from krtour.map_admin.app import create_app
from krtour.map_admin.db import get_session
from krtour.map_admin.routers import admin_issues as router_mod
...
def test_patch_geocode_action_503_when_base_url_unset(
    ...
    async def _reverse(_lon: float, _lat: float) -> dict[str, Any] | None:
        raise router_mod._KraddrGeoUnavailable("kraddr-geo base URL 미설정")
