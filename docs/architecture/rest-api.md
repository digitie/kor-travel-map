...
> (ADR-048 #9). `docs/architecture/tripmate-rest-api.md`는 PinVi **소비 매핑 view**로 수렴하고 계약
...
> 본 문서가 전 표면 계약 정본이다. `docs/architecture/tripmate-rest-api.md`는 PinVi 소비 매핑 view이며
> 계약 세부는 이 문서를 따른다.
