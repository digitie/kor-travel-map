...
def test_ops_live_websocket_initial_snapshot(
    ...
    from kortravelmap.admin.routers import ops_live as live_mod
...
def test_ops_metrics_maps_counts(
    ...
    from kortravelmap.admin.routers import ops as router_mod
...
def test_health_deep_ok(
    ...
    from kortravelmap.admin.routers import ops as router_mod
    from kortravelmap.admin.routers.ops import OpsHealthCheck
