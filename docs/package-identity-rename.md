...
| Python import(메인) | `from krtour.map import ...` | `import kortravelmap as ktm` |
| Admin distribution | `krtour-map-admin` | `kor-travel-map-admin` |
| Admin import | `from krtour.map_admin import ...` | `from kortravelmap.admin import ...` |
| Dagster distribution | `krtour-map-dagster` | `kor-travel-map-dagster` |
| Dagster import | `from krtour.map_dagster import ...` | `from kortravelmap.dagster import ...` |
...
- T-226d: runtime/deployment identity 전파
  ...
  - DB 기본값, RustFS bucket/volume 이름, Docker/image/service 표시명 갱신
