...
- `0202_tvn40_curation_receipts.py`부터 `0224_c7_acceptance_external_system_scope.py`까지 —
  bridge 뒤에 이어지는 T-VN-40 단일 체인이며, 현재 head는
  `0224_c7_acceptance_external_system_scope`다.
...
1. 파일은 `alembic/versions/0224_<name>.py`,
   `down_revision = "0224_c7_acceptance_external_system_scope"`(= 현재 head)로 잇는다.
