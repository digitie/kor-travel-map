...
- [`docs/architecture/tripmate-rest-api.md`](docs/architecture/tripmate-rest-api.md) — PinVi 연계 REST API params/returns 계약
...
- [`docs/tripmate-integration.md`](docs/tripmate-integration.md) — PinVi ↔ kor-travel-map OpenAPI 연동
