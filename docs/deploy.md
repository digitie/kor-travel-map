...
자동화는 후속 T-209b/T-209e에서 확장한다. `T-209e-a` 기준 cold backup script와
runbook은 제공되며, restore 자동화/admin router/hot-swap UI는 후속이다.
...
산출물과 검증 절차는 `docs/backup-restore.md`를 따른다.
...
- RustFS/객체 저장소를 포함한 restore 자동화, admin router, hot-swap UI.
