...
| [docker-app.md](./docker-app.md) | 독립 Docker app 기동/중지/스모크. 고정 포트: API 12301, admin UI 12305, Dagster 12302 |
...
| 항목 | 정책 | 근거 |
|------|------|------|
| Git source of truth | **NTFS** (`F:\dev\kor-travel-map*`). 편집·커밋·PR은 Windows Git. | AGENTS.md, ADR |
