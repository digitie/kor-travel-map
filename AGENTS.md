...
> `kortravelmap`, 권장 예시는 `import kortravelmap as ktm`로 clean cut한다. 아래 표는 T-226c/d/e
> 적용 전 현재 코드/운영값이다. 전환 정본은 `docs/package-identity-rename.md`.
