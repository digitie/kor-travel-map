...
- **결정 (2026-06-01 사용자)**: 보류 않고 **즉시 rename** — `krtour-map-admin`
  → **`krtour-map-admin`** (Python namespace `krtour.map_admin` →
  `krtour.map_admin`, settings env prefix `KRTOUR_MAP_ADMIN_` → `KRTOUR_MAP_ADMIN_`,
