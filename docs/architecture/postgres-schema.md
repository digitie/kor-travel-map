...
- `0202_tvn40_curation_receipts.py`부터 `0223_tvn40_identity_mappings.py`까지 —
  bridge 뒤에 이어지는 T-VN-40 단일 체인이며, 현재 head는
  `0223_tvn40_identity_mappings`다.
...
1. 파일은 `alembic/versions/0224_<name>.py`,
   `down_revision = "0223_tvn40_identity_mappings"`(= 현재 head)로 잇는다.
