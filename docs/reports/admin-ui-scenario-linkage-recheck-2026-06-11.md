...
`docs/runbooks/admin-ui-screen-checklist.md`, `packages/krtour-map-admin/frontend/src/app`,
`packages/krtour-map-admin/frontend/src/api`, `packages/krtour-map-admin/src/krtour/map_admin/routers`,
`packages/krtour-map-admin/openapi*.json`, TripMate `docs/tasks.md` T-130 및
`docs/krtour-map-requirements.md` §6을 대조했다.
...
TripMate T-130은 비로그인 `/public/*` 구현이며, 현재 차단 사유는 krtour-map
