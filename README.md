...
> frontend Next.js 16 + `maplibre-vworld-js#v0.1.3`. ADR 현황: **001~057 accepted**
> (다음 후보 058). ADR-048은 `/v1` REST clean cut + 정합성 표준, ADR-053은
...
- [`docs/decisions.md`](docs/decisions.md) — ADR 누적 (ADR-001~057)
