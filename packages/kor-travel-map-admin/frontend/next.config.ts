 ...
 *
 * 운영 옵션 A (standalone): 12705 포트로 직접 listen. backend(12701) 별도.
...
const config: NextConfig = {
  ...
  // monorepo workspace의 @kor-travel-map/map-marker-react (ADR-029, ADR-043 — private:
  // true, registry 게시 X)를 transpile.
  transpilePackages: ["@kor-travel-map/map-marker-react"],
