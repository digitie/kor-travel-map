...
`kor-travel-map`의 누적 ADR. 파일당 1개(`NNN-<slug>.md`)로 둔다. **다음 후보 = ADR-088.**
...
| ADR-087 | DB 소유 dataset operation과 immutable observation head | [087-provider-dataset-operation-and-observation-model.md](087-provider-dataset-operation-and-observation-model.md) |
