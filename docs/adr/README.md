...
`kor-travel-map`의 누적 ADR. 파일당 1개(`NNN-<slug>.md`)로 둔다. **다음 후보 = ADR-085.**
...
| ADR-084 | kind별 typed subtype 분해와 배타 arc | [084-typed-feature-subtypes.md](084-typed-feature-subtypes.md) |
