...
- API `http://127.0.0.1:12301`(admin UI `12305`, Dagster `12302`, Postgres host `5432`,
  RustFS `12101`/`12105`). `TRIPMATE_KRTOUR_MAP_API_BASE_URL`은 host root까지만 포함하고,
...
[`docs/public-views-api.md`](public-views-api.md)를 따른다. T-222b(2026-06-12)부터
이 표면은 `openapi.user.json` 사용자 profile과 `@krtour/map-user-client` 생성 타입에
포함한다.
