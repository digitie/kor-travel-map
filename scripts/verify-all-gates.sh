...
run_gate "mypy d2 lane" py 'python -m mypy --strict scripts/admin_feature_live_fixture.py scripts/admin_feature_live_state.py scripts/admin_feature_live_supervisor.py scripts/dagster_run_completion_gate.py'
run_gate "mypy image scripts" py 'python -m mypy --strict docker/application-schema-contract.py docker/application-schema-db-contract.py docker/application-schema-final-permit.py docker/application-schema-fresh-300.py docker/application-schema-fresh-finalize.py docker/application-schema-head.py docker/dagster-storage-migrate.py'
