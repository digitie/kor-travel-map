CREATE OR REPLACE PROCEDURE feature.record_manual_provider_dedup_candidate(IN p_manual_feature_id uuid, IN p_provider_feature_id uuid, IN p_scores jsonb, IN p_detector_causation jsonb, OUT o_case_id uuid, OUT o_outcome text)
