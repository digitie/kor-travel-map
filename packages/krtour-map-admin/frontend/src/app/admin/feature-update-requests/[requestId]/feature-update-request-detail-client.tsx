...
export function FeatureUpdateRequestDetailClient({
  ...
  return (
    <AdminShell
      ...
      description="feature update request scope, matched scope, job, Dagster run 상태를 확인합니다."
      section="Admin"
      title="Feature update request"
    >
      <div className="flex flex-col gap-4">
        {request.isError || cancelRequest.isError || runNow.isError ? (
          <Alert variant="destructive">
            <AlertTitle>request 조회 실패</AlertTitle>
            <AlertDescription>
          ...
          <>
            <section className="rounded-lg border bg-background p-4">
              ...
              <dl className="mt-4 grid gap-3 text-sm md:grid-cols-2 xl:grid-cols-4">
                ...
                <div>
                  <dt className="text-muted-foreground">Dagster run</dt>
            ...
            <section className="grid gap-4 xl:grid-cols-2">
              ...
              <div className="rounded-lg border bg-background p-4">
                <div className="mb-2 font-medium">Matched scope</div>
                <pre className="max-h-[32rem] overflow-auto rounded-md bg-muted p-3 text-xs">
