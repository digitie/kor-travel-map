...
def sync_mois_source_db(
    ...
    *,
    ...
    ``settings.mois_source_db_path``(env ``KRTOUR_MAP_MOIS_SOURCE_DB_PATH``)를 대상
    ...
    if db_path is None:
        raise ProviderCredentialMissing(
            ...
            "KRTOUR_MAP_MOIS_SOURCE_DB_PATH를 설정하라."
        )
...
MOIS_SOURCE_SYNC_JOB_TAGS: Final[dict[str, str]] = {
    ...
    "krtour_map.job_kind": "mois_localdata_source_sync",
    "krtour_map.provider": "python-mois-api",
