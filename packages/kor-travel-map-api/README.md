...
| `KOR_TRAVEL_MAP_API_ADMIN_PROXY_SECRET` | (운영 필수) | admin REST BFF 검증과 ops-live 60초 ticket HMAC 검증에 쓰는 server-only secret(32자 이상, frontend의 `KOR_TRAVEL_MAP_ADMIN_PROXY_SECRET`과 동일 값) |
