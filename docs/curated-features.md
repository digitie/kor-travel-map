...
> DB/API/OpenAPI foundation 구현 완료(T-223c-1).
> Dagster asset group과 Admin UI는 T-223c-2/c-3 후속.
...
4. Dagster `curated_features` group과 rule apply/status sweep/source metadata refresh asset을 추가한다. **T-223c-2**.
