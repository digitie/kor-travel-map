...
Revision ID: 0120_tvn40_import_item_cmd
Revises: 0119_tvn40_import_plans
"""
...
revision: str = "0120_tvn40_import_item_cmd"
down_revision: str | Sequence[str] | None = "0119_tvn40_import_plans"
...
def downgrade() -> None:
    raise RuntimeError("0120 is forward-only; rebuild with the T-VN-40 release head")
