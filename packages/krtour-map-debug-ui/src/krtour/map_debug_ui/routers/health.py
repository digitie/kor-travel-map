"""``krtour.map_debug_ui.routers.health`` — ``GET /debug/health``.
...
class HealthResponse(BaseModel):
    ...
    service: str = Field(description="서비스 식별자 — ``'krtour-map-debug-ui'``.")
...
async def get_health() -> HealthResponse:
    ...
    return HealthResponse(status="ok", service="krtour-map-debug-ui")
