...
**진행 중**: ADR-045 독립 프로그램화 후속. main은 PR#204(T-RV-37a shell script
실행 셸 문서화)까지 merged. 코드 리뷰 후속 흐름으로, 이번 PR은
`T-RV-37b`(`dagster-boundary.md` purge schedule stale 문서 제거)을 닫는다.
