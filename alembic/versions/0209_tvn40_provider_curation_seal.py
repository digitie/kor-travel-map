...
Revision ID: 0209_tvn40_provider_seal
Revises: 0208_tvn40_source_catalog
...
revision: str = "0209_tvn40_provider_seal"
down_revision: str | Sequence[str] | None = "0208_tvn40_source_catalog"
...
def downgrade() -> None:
    raise RuntimeError("0209_tvn40_provider_seal is forward-only; rebuild with the T-VN-40 release head")
