...
from kortravelmap.offline_upload import OfflineUploadLoadResult

from kortravelmap.dagster.offline_uploads import offline_upload_load_job
...
def test_offline_upload_load_job_executes_client() -> None:
    ...
    result = offline_upload_load_job.execute_in_process(
        ...
        resources={"kor_travel_map_client": client, "offline_upload_store": store},
    )
