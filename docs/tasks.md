...
- [x] T-VN-FINAL-REBUILD — B4를 재판정해 최종 acceptance 배리어를 **열었다**(2026-09-04 소유자 서명, 근거는 재계산 대조). 착수 전 [`docs/tasks-acceptance.md`](tasks-acceptance.md)의 재시도 금지 candidate 목록을 확인한다.
