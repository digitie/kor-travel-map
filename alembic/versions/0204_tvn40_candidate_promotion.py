...
Revision ID: 0204_tvn40_candidate_promotion
Revises: 0203_tvn40_candidate_commands
...
revision: str = "0204_tvn40_candidate_promotion"
down_revision: str | Sequence[str] | None = "0203_tvn40_candidate_commands"
...
def downgrade() -> None:
    raise RuntimeError("0204_tvn40_candidate_promotion is forward-only; rebuild with the T-VN-40 release head")
