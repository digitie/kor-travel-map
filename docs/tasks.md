...
완료됐다. 이번 PR은 남은 리뷰 후속 중 같은 운영 hardening/performance 범위인
`T-RV-27`, `T-RV-40`, `T-RV-41`을 한 묶음으로 닫는다.
남은 T-RV 계열은 provider별 public client live fetcher wiring인 `T-RV-04b`와
`T-RV-37` 잔여 hygiene이다.
