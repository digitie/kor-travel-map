...
BEGIN
    ...
    END IF;
    EXECUTE 'ALTER FUNCTION feature.current_theme_candidate_snapshot(p_rule_id uuid, p_source_entity_key text, p_feature_id uuid) OWNER TO ktm_curation_command_owner';
    IF NOT had_create THEN
