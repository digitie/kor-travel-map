...
from krtour.map_dagster.curated_features import (
...
from krtour.map_dagster.maintenance import MAINTENANCE_RETRY_POLICY
...
def _context(client: _Client) -> Any:
    return build_asset_context(resources={"krtour_map_client": client})
