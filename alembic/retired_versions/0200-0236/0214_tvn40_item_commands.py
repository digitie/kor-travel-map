...
Revision ID: 0214_tvn40_item_cmds
Revises: 0213_tvn40_collection_cmds
"""
...
revision: str = "0214_tvn40_item_cmds"
down_revision: str | Sequence[str] | None = "0213_tvn40_collection_cmds"
...
def downgrade() -> None:
    raise RuntimeError("0214_tvn40_item_cmds is forward-only; rebuild with the T-VN-40 release head")
