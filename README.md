...
Docker 독립 프로그램으로 운영하며, TripMate는 OpenAPI(HTTP)로 연동한다. 고정
...
- **PostgreSQL 기본 DB**: `kor_travel_map` (TripMate 공유 DB 아님)
...
- [`docs/architecture/tripmate-rest-api.md`](docs/architecture/tripmate-rest-api.md) — TripMate 연계 REST API params/returns 계약
- [`docs/architecture/public-views-api.md`](docs/architecture/public-views-api.md) — TripMate T-130 공개 해수욕장/축제 뷰 후보 사양
