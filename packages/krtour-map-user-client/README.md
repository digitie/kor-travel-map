# @krtour/map-user-client

krtour-map **user-facing** OpenAPI(`packages/krtour-map-admin/openapi.user.json`,
...
`npm -w packages/krtour-map-user-client run gen:types` → `type-check` →
